...
db.serialize(function(){
  if (!exists) {
    db.run("CREATE TABLE LOGINS (username TEXT NOT NULL, salt HASHBYTES NOT NULL, hash HASHBYTES NOT NULL, permissionlevel INTEGER NOT NULL)");
  ...
  db.get(query, function(err,row){
    if (row) {
      ...
      db.serialize(function(){
        ...
        console.log('added regular user ' + newUser + ' to db');
    });
